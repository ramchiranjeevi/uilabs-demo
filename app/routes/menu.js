...
export default Ember.Route.extend({
  model: function() {
    ...
    {'action': 'cutAction', 'name':'Cut', 'children': [], 'icon' : 'edit icon', 'type': '⌘X'},
    {'action': 'copyAction', 'name':'Copy', 'children': [],  'icon' : 'edit icon', 'type': '⌘C'},
    {'action': 'pasteAction', 'name':'Paste', 'children': [], 'icon' : 'globe icon', 'type': '⌘V'},
    ...
    {'action': '', 'name': 'More', 'arrowClass':'dropdown', 'icon' : 'grid layout icon',
