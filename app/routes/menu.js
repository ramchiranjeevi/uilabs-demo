...
export default Ember.Route.extend({
  model: function() {
    ...
    'children': [{'action':'', 'name': 'Edit' , 'isSubMenu': 'true', 'icon' : 'edit icon', 'arrowClass':'', 'tab_index' : 0, 'type': '.ed', 'children': []},
    {'action':'', 'name': 'Language' ,  'isSubMenu': 'true', 'icon' : 'globe icon', 'arrowClass':'', 'tab_index' : 1, 'type': '.ch', 'children': []},
    {'action':'', 'name': 'Settings' , 'isSubMenu': 'true', 'icon' : 'settings icon', 'arrowClass':'', 'tab_index' : 2, 'type': '.se','children': []},]}];
    return name;
  },
